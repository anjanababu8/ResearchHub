<nav class="navbar navbar-inverse" role="navigation" style="z-index:999">
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <!-- <?php if(Auth::check()): ?> -->
                    <li><img class="media-object" alt="<?php echo e(Auth::user()->fullname()); ?>" src="<?php echo e(Auth::user()->profilephoto==null?URL::to('/').'/img/default_profile_photo.jpg':Auth::user()->profilephoto); ?>" style="padding-top:5px;height:45px; width:40px;"></li>
