	    			...
	    			<?php if( $status->type == 0 ): ?>
				        <div class="media">
						    <a class="pull-left" href="#">
						        <img class="media-object" alt="<?php echo e($status->user->fullname()); ?>" src="<?php echo e($status->user->profilephoto==null?URL::to('/').'/img/default_profile_photo.jpg':$status->user->profilephoto); ?>" style="height:80px; width:80px;">
						    </a>
