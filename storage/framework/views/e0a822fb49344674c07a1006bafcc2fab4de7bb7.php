		        ...
		        <div class="login-panel panel panel-default">
		            ...
		            <div class="panel-body">
		        		<div class="col-xs-6 col-sm-3 placeholder">
			              	<img src="<?php echo e($profilePictureLarge); ?>" width="200" height="200" class="img-responsive" alt="Generic placeholder thumbnail">
			            </div>
		                <form role="form" method="POST" action="<?php echo e(URL::route('linkedin_complete_post')); ?>" accept-charset="UTF-8">
		                	<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
		                	<input type="hidden" name="profilePicture" value="<?php echo e($profilePictureLarge); ?>">
		                    <fieldset>
		                        <div class="form-group">
		                            <input class="form-control" placeholder="First Name" id="data-registration-firstName" value="<?php echo e($firstName); ?>" disabled>
		                        	<input type="hidden" name="firstname" value="<?php echo e($firstName); ?>">
		                        </div>
		                        <div class="form-group">
		                            <input class="form-control" placeholder="Last Name" id="data-registration-lastName" value="<?php echo e($lastName); ?>" disabled>
		                        	<input type="hidden" name="lastname" value="<?php echo e($lastName); ?>">
		                        </div>
		                        <div class="form-group">
		                            <input class="form-control" placeholder="Email" id="data-registration-email" value="<?php echo e($emailAddress); ?>" disabled>
		                        	<input type="hidden" name="email" value="<?php echo e($emailAddress); ?>">
		                        </div>
		                        <div class="form-group">
		                        ...
		                        <div class="form-group">
		                            <input class="form-control" placeholder="Phone Number" id="data-linkedin-profile" type="text" value="<?php echo e($linkedinProfile); ?>" disabled>
		                            <input type="hidden" name="linkedin" value="<?php echo e($linkedinProfile); ?>">
		                        </div>
		                        <div class="form-group">
		                            <input class="form-control" placeholder="Facebook-URL" id="data-facebook-profile" name="facebook" type="text">
		                        </div>
		                        <input type="hidden" name="linkedin_id" value="<?php echo e($id); ?>">
